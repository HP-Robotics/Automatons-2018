 ...
 */
public class SnazzyPIDCalculator implements PIDInterface, LiveWindowSendable {
  ...
  public SnazzyPIDCalculator(double Kp, double Ki, double Kd, double Kf, PIDSource source,
   ...
   */
  @SuppressWarnings("ParameterName")
  public SnazzyPIDCalculator(double Kp, double Ki, double Kd, PIDSource source, PIDOutput output,
                       double period) {
